...
@section('title', 'Create User - Analog Pharmacy')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Add a new user to the system</p>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="notes" id="notes" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent dark:bg-gray-700 dark:text-white @error('notes') border-red-500 @enderror">{{ old('notes') }}</textarea>
                        @error('notes')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
        ...
        <div class="text-center">
            ...
            <div class="relative w-16 h-16 mx-auto mb-6">
                <div class="absolute inset-0 flex items-center justify-center">
                    <i class="fas fa-user-plus text-green-500 text-3xl animate-pulse"></i>
                </div>
            </div>
...
function showUserActionLoading(action) {
    const messages = {
        ...
        'processing': 'Processing user information...'
    };
...
document.getElementById('createUserForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        showUserActionLoading('creating');
        ...
        if (data.success) {
            ...
            hideUserLoading();
            showUserSuccessNotification('User created successfully!');
            ...
            if (data.errors) {
                ...
                if (window.NotificationService) {
                    window.NotificationService.error('Failed to create user: ' + (data.message || 'Unknown error'));
                }
            }
        }
        ...
        hideUserLoading();
        if (window.NotificationService) {
            window.NotificationService.error('Failed to create user. Please try again.');
        }
    } finally {
        // Reset button state
