...
@section('title', 'Create Role - Analog Pharmacy')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Define a new role with specific permissions</p>
                </div>
...
document.getElementById('createRoleForm').addEventListener('submit', async function(e) {
    ...
    try {
        // Show loading state
        submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i>Creating Role...';
        ...
        if (data.success) {
            ...
            if (window.NotificationService) {
                window.NotificationService.success('Role created successfully!');
            } else {
